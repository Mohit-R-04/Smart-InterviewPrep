...
function App() {
    ...
    const schedule = useMemo(() => {
        ...
        // AI scheduler now uses serverless proxy (no API key needed in frontend)
        generateAISchedule(problemsData, config, true)
            .then(result => {
                if (result.aiGenerated) {
                    console.log('✅ Schedule generated by Gemini AI');
                    return result.schedule;
                } else {
                    console.log('⚠️ Using algorithmic scheduler');
